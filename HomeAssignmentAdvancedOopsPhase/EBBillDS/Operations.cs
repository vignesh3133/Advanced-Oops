...
namespace EBBillDS
{
    public class Operations
    {
        ...
        public static CustomList<EBMeterDetails> entryList=new CustomList<EBMeterDetails>();
        ...
        public void Default()
        {
            userList.Add(new UserDetails("Ravi","858585","Theni"));
            userList.Add(new UserDetails("Baskar","758585","Chennai"));

            entryList.Add(new EBMeterDetails(userList[0].CustomerID,40,MeterType.Domestic,"March-2023"));
            entryList.Add(new EBMeterDetails(userList[1].CustomerID,40,MeterType.Domestic,"March-2023"));
        }
    }
}